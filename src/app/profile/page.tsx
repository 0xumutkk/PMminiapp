      ...
      <div className={styles.profileHub}>
        <section className={styles.profileHero}>
          <div className={styles.profileHeroTop}>
            ...
            <span className={styles.profileHeroBadge}>{isPortfolio ? "Portfolio" : "Activity"}</span>
          </div>
        ...
        <nav className={styles.profileSwitch} aria-label="Profile sections">
          <Link
            ...
            className={`${styles.profileSwitchItem}${
              activeView === "portfolio" ? ` ${styles.profileSwitchItemActive}` : ""
            }`}
          ...
          <Link
            ...
            className={`${styles.profileSwitchItem}${
              activeView === "activity" ? ` ${styles.profileSwitchItemActive}` : ""
            }`}
