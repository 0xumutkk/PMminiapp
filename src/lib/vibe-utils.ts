...
const VIBES: Record<string, MarketVibe> = {
    crypto: {
        ...
        animationSpeed: 15,
        label: "Crypto",
        bgImageUrl: "/categories/crypto.png?v=fresh2",
    },
    politics: {
        colors: ["#ff003d", "#ff7a00", "#5200ff"],
        animationSpeed: 20,
        label: "Politics",
        bgImageUrl: "/categories/politics.png?v=fresh2",
    },
    sports: {
        colors: ["#0bd52d", "#00ffc2", "#0052ff"],
        animationSpeed: 12,
        label: "Sports",
        bgImageUrl: "/categories/sports.png?v=fresh2",
    },
    entertainment: {
        colors: ["#ff00f5", "#7000ff", "#00c2ff"],
        animationSpeed: 18,
        label: "Entertainment",
        bgImageUrl: "/categories/entertainment.png?v=fresh2",
    },
    science: {
        colors: ["#00f0ff", "#0052ff", "#7000ff"],
        animationSpeed: 15,
        label: "Science",
        bgImageUrl: "/categories/science.png?v=fresh2",
    },
    economy: {
        colors: ["#ffd700", "#ff7a00", "#060913"],
        animationSpeed: 20,
        label: "Economy",
        bgImageUrl: "/categories/economy.png?v=fresh2",
    },
    conspiracy: {
        colors: ["#00ffc2", "#0bd52d", "#060913"],
        animationSpeed: 25,
        label: "Conspiracy",
        bgImageUrl: "/categories/conspiracy.png?v=fresh2",
    },
    default: {
        colors: ["#0052ff", "#8eb1ff", "#060913"],
        animationSpeed: 25,
        label: "Market",
        bgImageUrl: "/categories/default.png?v=fresh2",
    },
};
